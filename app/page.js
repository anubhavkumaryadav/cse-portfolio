...
export default function PortfolioPage() {
  ...
  // 1. BOOT SEQUENCE SCREEN (image1.jpeg)
  if (loading || !data) {
    return (
      <div className="fixed inset-0 z-50 bg-[#03060a] flex flex-col items-center justify-center font-mono text-cyan-400 p-6 select-none overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            fill
            priority
            className="object-cover object-center filter brightness-[0.35] contrast-125 blur-[1px]"
            onError={(e) => {
  ...
  return (
    <div className="min-h-screen text-slate-200 selection:bg-cyan-500 selection:text-black relative overflow-x-hidden font-sans scroll-smooth">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <nav className="flex items-center gap-1 sm:gap-2 text-xs font-mono">
              <a href="#about" className="px-3 py-1.5 rounded-lg text-slate-300 hover:text-cyan-300 hover:bg-cyan-950/40 transition">About</a>
              <a href="#skills" className="px-3 py-1.5 rounded-lg text-slate-300 hover:text-cyan-300 hover:bg-cyan-950/40 transition">Skills</a>
              <a href="#projects" className="px-3 py-1.5 rounded-lg text-slate-300 hover:text-cyan-300 hover:bg-cyan-950/40 transition">Projects</a>
              <a href="#experience" className="px-3 py-1.5 rounded-lg text-slate-300 hover:text-cyan-300 hover:bg-cyan-950/40 transition hidden sm:inline-block">Experience</a>
              <a href="#education" className="px-3 py-1.5 rounded-lg text-slate-300 hover:text-cyan-300 hover:bg-cyan-950/40 transition hidden sm:inline-block">Education</a>
            </nav>
      ...
      <footer className="border-t border-cyan-950/80 mt-24 py-8 text-center text-xs font-mono text-slate-500 relative z-10">
